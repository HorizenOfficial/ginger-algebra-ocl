...
// pub struct PolycommitWorker<G>
// where
//     G: AffineCurve
// {
//     kernels: Vec<SinglePolycommitKernel<G>>
// }

// impl<G> PolycommitWorker<G>
// where
//     G: AffineCurve
// {
//     pub fn create() -> GPUResult<PolycommitWorker<G>> {
...
//     pub fn get_kernels(&self) -> &[SinglePolycommitKernel<G>]
//     {
