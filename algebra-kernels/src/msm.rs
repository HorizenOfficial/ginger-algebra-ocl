...
// pub struct MSMWorker<G>
// where
//     G: AffineCurve
// {
//     // #[derivative(Default(value="Vec::<SingleMSMKernel<G>>::new()"))]
//     kernels: Vec<SingleMSMKernel<G>>
// }
...
//     G: AffineCurve
// {
//     pub fn create() -> GPUResult<MSMWorker<G>> {
...
//     pub fn get_kernels(&self) -> &[SingleMSMKernel<G>]
//     {
